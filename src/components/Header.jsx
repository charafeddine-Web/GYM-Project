                ...
                <div className="relative isolate overflow-hidden bg-gray-900 px-6 pt-10 sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
                    ...
                    <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
                        ...
                        <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
                            <div className="relative group">
                                <div
                                    className="relative w-40 h-12 text-center opacity-90 overflow-hidden rounded-xl bg-black z-10"
                                >
                                    <div
                                    ...
                                    <Link
                                        to="/signin"
                                        className="relative flex items-center justify-center text-center text-white z-[1] opacity-90 rounded-2xl inset-0.5 bg-black h-full w-full px-6 rounded-xl bg-black"
                                    >
                                        Get Started
                                    </Link>
                                    <div
                    ...
                    <div className="flex justify-center pt-10 lg:justify-start lg:w-1/2 lg:ml-8">
                        <img
                            ...
                            alt="coach gym"
                            className="saturate-100 w-100 h-full object-cover rounded-full border-4 border-indigo-500 shadow-xl"
                        />
                    </div>
                </div>
            </div>
